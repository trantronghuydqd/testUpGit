...
// Action Creators
const fetchProductsSuccess = (payload) => ({ type: "FETCH_PRODUCTS", payload });
const addProductSuccess = (payload) => ({ type: "ADD_PRODUCT", payload });
const updateProductSuccess = (payload) => ({ type: "UPDATE_PRODUCT", payload });
const deleteProductSuccess = (payload) => ({ type: "DELETE_PRODUCT", payload });
